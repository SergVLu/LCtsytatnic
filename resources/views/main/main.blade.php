...
<main>
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    <div class="blog-post-card blog-post-1 mb-4 mb-md-0" data-aos="fade-right">
                        <p class="post-category">Сокровенное</p>
                        <h2 class="post-title">Дatest blog post for more update.Check our latest blog post for more update.Check our latest blog post for more update.Check our .</h2>
                        <a href="#!" class="post-link">Learn more</a>
                    </div>
                </div>
                <div class="col-md-6 mb-4">
                    <div class="blog-post-card blog-post-2" data-aos="fade-left">
                        <p class="post-category">Скрытое</p>
                        <h2 class="post-title">Check our latest blog post for more update.</h2>
                        <a href="#!" class="post-link">Learn more</a>
                    </div>
                </div>
                <div class="col-md-6 mb-4">
                    <div class="blog-post-card blog-post-2 mb-4 mb-md-0 " style="background-color: rgb(225, 225, 249)" data-aos="fade-right">
                        <p class="post-category">Прошлое</p>
                        <h2 class="post-title">Дatest blog post for more update.Check our latest blog post for more update.Check our latest blog post for more update.Check our .</h2>
                        <a href="#!" class="post-link">Learn more</a>
                    </div>
                </div>
                <div class="col-md-6 mb-4">
                    <div class="blog-post-card blog-post-1" style="background-color: rgb(253, 155, 155)"data-aos="fade-left">
                        <p class="post-category">Явное</p>
                        <h2 class="post-title">Check our latest blog post for more update.</h2>
                        <a href="#!" class="post-link">Learn more</a>
                    </div>
                </div>
    ...
    <section class="edica-landing-section edica-landing-services">
        <div class="container">
            <h4 class="edica-landing-section-subtitle">Предлагаемые изречения</h4>
            <h2 class="edica-landing-section-title">Какую категорию <br> Выберете?</h2>
            <div class="row">
                <div class="col-md-6 landing-service-card" data-aos="fade-right">
                    ...
                    <h4 class="service-card-title">Магия</h4>
